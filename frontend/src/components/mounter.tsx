...
const mountComponent = <P, R = boolean>(
  Component: React.ComponentType<P & { onClose?: () => void; onSave?: (result: R) => void | Promise<void> }>,
  props?: Partial<P & { onClose?: () => void; onSave?: (result: unknown) => void | Promise<void> }>
): Promise<R> => new Promise((resolve) => {
