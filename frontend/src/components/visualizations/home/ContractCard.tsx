...
export default function ContractCard() {
  return (
    <div className="absolute top-16 left-20">
      <motion.div
        className="absolute w-[105px] h-[148px] bg-zinc-50 border border-zinc-300 shadow-md rounded-xs rotate-[-5deg]"
      />
      <motion.div
        className="absolute w-[105px] h-[148px] bg-zinc-50 border border-zinc-300 shadow-md rounded-xs rotate-[-2deg]"
      />
      ...
      >
        ...
        <div className="text-[6px] mt-1 leading-tight">
          <p><strong>Parties:</strong> Alice Corp & Bob Ltd.</p>
          <p><strong>Effective Date:</strong> 2025-03-10</p>
          <p><strong>Scope:</strong> Web Design Services</p>
        </div>

        <div className="text-[6px] mt-2 leading-tight italic text-zinc-600">
          <p>Both parties must adhere to the project milestones and agreed payment terms.</p>
        </div>
