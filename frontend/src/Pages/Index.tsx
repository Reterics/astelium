import {
  FiCheckCircle, FiCheckSquare, FiDatabase, FiFileText, FiUsers
} from 'react-icons/fi';
  ...
  return (
    <div className="min-h-screen text-black relative overflow-hidden">
      ...
      <section className="py-16 bg-[#e0f2ff] text-center">
        <h2 className="text-3xl font-bold text-zinc-900">Who Benefits from Astelium?</h2>
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            ...
            >
              ...
              <h3 className="text-xl font-semibold mt-4 text-zinc-900">{useCase.title}</h3>
      ...
      <section className="py-16 bg-white text-center">
        ...
        <div className="mt-8 max-w-4xl mx-auto text-left space-y-6">
          {[
            { question: "How does Astelium help manage projects?", answer: "Astelium provides a task-oriented workflow, Kanban board, and reporting tools to track project progress efficiently." },
            { question: "Can I customize features for my business needs?", answer: "Yes! Our Enterprise plan includes custom feature requests and integrations tailored to your specific requirements." },
            { question: "Does Astelium support invoicing and contracts?", answer: "Yes! The Pro plan includes invoice and contract management, helping businesses streamline financial operations." },
            { question: "Is my data secure?", answer: "Astelium uses industry-standard encryption and secure hosting to ensure your data remains safe at all times." },
            { question: "What integrations does Astelium support?", answer: "Astelium supports a range of external integrations including accounting software, cloud storage, and more." },
            { question: "Do you offer a free trial?", answer: "Yes, you can try Astelium for free with limited features before upgrading to a paid plan." },
          ].map((faq, index) => (
            <motion.div whileHover={{ scale: 1.05 }} key={index} className="p-4 bg-zinc-50 rounded shadow border border-zinc-300">
      ...
      <footer className="bg-white text-zinc-900 py-10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          <div>
            ...
            <p className="mt-2 text-zinc-600">Your all-in-one solution for project management and CRM.</p>
          </div>
          <div>
